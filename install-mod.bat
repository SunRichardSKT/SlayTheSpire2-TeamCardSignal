...
set "MANIFEST_SRC="
if exist "!MOD_SRC_DIR!\!MOD_NAME!.json" (
    set "MANIFEST_SRC=!MOD_SRC_DIR!\!MOD_NAME!.json"
) else (
    for %%F in ("!MOD_SRC_DIR!\*.json") do (
        if /I not "%%~nxF"=="mod_manifest.json" if not defined MANIFEST_SRC set "MANIFEST_SRC=%%F"
    )
)
...
set "PCK_MANIFEST=!TEMP!\!MOD_NAME!_pck_manifest.json"
...
echo   - DLL copied
if exist "!MOD_SUBFOLDER!\mod_manifest.json" del /F /Q "!MOD_SUBFOLDER!\mod_manifest.json" >nul 2>nul

if defined MANIFEST_SRC (
    copy /Y "!MANIFEST_SRC!" "!MOD_SUBFOLDER!\!MOD_NAME!.json" >nul
    echo   - Source manifest copied
    copy /Y "!MANIFEST_SRC!" "!PCK_MANIFEST!" >nul
    echo   - temporary pck manifest generated
) else (
    echo   - WARNING: No manifest found in !MOD_SRC_DIR!
    echo {> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "id": "!MOD_NAME!",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "name": "!MOD_NAME!",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "pck_name": "!MOD_NAME!",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "version": "0.1.0",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "author": "",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "description": "",>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "has_dll": true,>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "has_pck": true,>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "affects_gameplay": true,>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   "dependencies": []>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo }>> "!MOD_SUBFOLDER!\!MOD_NAME!.json"
    echo   - !MOD_NAME!.json generated
    echo {> "!PCK_MANIFEST!"
    echo   "id": "!MOD_NAME!",>> "!PCK_MANIFEST!"
    echo   "pck_name": "!MOD_NAME!",>> "!PCK_MANIFEST!"
    echo   "name": "!MOD_NAME!",>> "!PCK_MANIFEST!"
    echo   "version": "0.1.0",>> "!PCK_MANIFEST!"
    echo   "has_dll": true,>> "!PCK_MANIFEST!"
    echo   "has_pck": true,>> "!PCK_MANIFEST!"
    echo   "affects_gameplay": true,>> "!PCK_MANIFEST!"
    echo   "dependencies": []>> "!PCK_MANIFEST!"
    echo }>> "!PCK_MANIFEST!"
    echo   - temporary pck manifest generated
)
...
if exist "!GODOT_EXE!" (
    if exist "!PCK_SCRIPT!" (
        "!GODOT_EXE!" --headless --path "!PCK_BUILDER_DIR!" --script "!PCK_SCRIPT!" -- "!PCK_MANIFEST!" "!MOD_SUBFOLDER!\!MOD_NAME!.pck"
...
if exist "!PCK_MANIFEST!" del /F /Q "!PCK_MANIFEST!" >nul 2>nul
if exist "!MOD_SUBFOLDER!\mod_manifest.json" del /F /Q "!MOD_SUBFOLDER!\mod_manifest.json" >nul 2>nul
